      ...
      useEffect(() => {
        const fetchData = async () => {
          let response = await fetch(
            "https://newsapi.org/v2/everything?q=tesla&from=2023-04-20&sortBy=publishedAt&apiKey=32c33fd4552f42f4ba91b6f2af82185c"
          );
...
<h1 id="h1">Tesla Company News</h1> {value}</div>
